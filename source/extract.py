...
if __name__ == "__main__":
    ...
    file_path = resolve_path_to_file("../facebook_page.html")
    ...
    json_file_path = resolve_path_to_file(f"../extracted_link_{datetime.now().strftime("%Y-%m-%d")}.json")  # You can change the file name if needed
